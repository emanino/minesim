...
public class LayoutAtomTest {
	...
	public void testConstructor() throws FileNotFoundException, IOException {
		...
		LayoutAtom a = new LayoutAtom(0, new Position(0, 0, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom b = new LayoutAtom(0, new Position(1, 0, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom c = new LayoutAtom(0, new Position(2, 0, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
	...
	public void testUpdate() throws FileNotFoundException, IOException {
		...
		LayoutAtom a = new LayoutAtom(0, pos, oldState, new LayoutAtomStatus(prop, -1), 1.0, true);
	...
	public void testShortestPathTo() throws FileNotFoundException, IOException {
		...
		LayoutAtom b = new LayoutAtom(0, new Position(1, 0, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom c = new LayoutAtom(0, new Position(2, 0, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom d = new LayoutAtom(0, new Position(2, 1, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom e = new LayoutAtom(0, new Position(2, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom f = new LayoutAtom(0, new Position(1, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom g = new LayoutAtom(0, new Position(0, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom h = new LayoutAtom(0, new Position(0, 3, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
		LayoutAtom i = new LayoutAtom(0, new Position(0, 1, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true);
	...
	public void testShortestPathTo2() throws FileNotFoundException, IOException {
		...
		LayoutAtom a = new LayoutAtom(0, new Position(3, 0, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 0
		LayoutAtom b = new LayoutAtom(0, new Position(3, 1, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 1
		LayoutAtom c = new LayoutAtom(0, new Position(3, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 2
		LayoutAtom d = new LayoutAtom(0, new Position(3, 3, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 3
		LayoutAtom e = new LayoutAtom(0, new Position(3.05, 4, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 4
		LayoutAtom f = new LayoutAtom(0, new Position(3, 5, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 5
		LayoutAtom g = new LayoutAtom(0, new Position(3, 6, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 6
		LayoutAtom h = new LayoutAtom(0, new Position(4, 6, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 7
		LayoutAtom i = new LayoutAtom(0, new Position(5, 6, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 8
		LayoutAtom j = new LayoutAtom(0, new Position(5, 5, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 9
		LayoutAtom k = new LayoutAtom(0, new Position(5, 4, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 10
		LayoutAtom l = new LayoutAtom(0, new Position(5, 3, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 11
		LayoutAtom m = new LayoutAtom(0, new Position(5, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 12
		LayoutAtom n = new LayoutAtom(0, new Position(5, 1, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 13
		LayoutAtom o = new LayoutAtom(0, new Position(5, 0, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 14
		LayoutAtom p = new LayoutAtom(0, new Position(4, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 15
		LayoutAtom q = new LayoutAtom(0, new Position(2, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 16
		LayoutAtom r = new LayoutAtom(0, new Position(1, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 17
		LayoutAtom s = new LayoutAtom(0, new Position(0, 2, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 18
		LayoutAtom t = new LayoutAtom(0, new Position(0, 4, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 19
		LayoutAtom u = new LayoutAtom(0, new Position(1, 4, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 20
		LayoutAtom v = new LayoutAtom(0, new Position(2, 4, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 21
		LayoutAtom w = new LayoutAtom(0, new Position(2, 6, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 22
		LayoutAtom x = new LayoutAtom(0, new Position(1, 6.02, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 23
		LayoutAtom y = new LayoutAtom(0, new Position(1, 5, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 24
		LayoutAtom z = new LayoutAtom(0, new Position(1, 3, 0), state, new LayoutAtomStatus(prop, -1), 1.1, true); // 25
