...
public class TestResult_b4 extends TestResultPositiveIfThen{
	
	/**
	 * The condition B4 is "If the carbon monoxide concentration is greater than 68 in a tunnel, and there is a person there, then activate the ventilation in that tunnel."
	 * @param positive
	 * @param m
	 * @return
	 */
	...
	public Pair<Set<String>, String> expectedSet(Mine m) {
		...
		return new ImmutablePair<Set<String>, String>(highCO,"ventilate");
	}
