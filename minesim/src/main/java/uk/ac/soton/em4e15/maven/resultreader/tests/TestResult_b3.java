...
public class TestResult_b3 extends TestResultPositiveIfThen{
	
	/**
	 * The condition B3 is "If temperature is greater than 38 in a tunnel, evacuate that tunnel."
	 * @param positive
	 * @param m
	 * @return
	 */
	...
	public Pair<Set<String>, String> expectedSet(Mine m) {
		...
		highTemp.retainAll(highTemp);
		return new ImmutablePair<Set<String>, String>(highTemp,"evacuate");
	}
